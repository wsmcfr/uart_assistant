...
- 当前最新稳定版 / Latest Stable: v1.8.1（发布于 2026-06-02 / released on 2026-06-02）
- 直链下载 / Direct Download: <https://github.com/wsmcfr/uart_assistant/releases/download/v1.8.1/ComAssistant_v1.8.1_Windows_x64_Portable.zip>
- 校验文件 / Checksum: <https://github.com/wsmcfr/uart_assistant/releases/download/v1.8.1/SHA256SUMS.txt>
<!-- LATEST_RELEASE:END -->
